...
public class NodeResource {
	...
	@PUT
	@Consumes("application/xml")
	public Response setKeyValue(TableRep tablerep) {
		return new NodeService(headers, uriInfo).setKeyValue(tablerep.entry[0].key, tablerep.entry[0].vals[0]);
	}
	
	@DELETE
	@Consumes("application/xml")
	public void deleteKeyValue(@QueryParam("key") String key, @QueryParam("val") String value) {
